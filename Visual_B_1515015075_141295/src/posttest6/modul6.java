...
public class modul6 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ibu Kartini", "Nurvita Sari", "Tere Liye", "W.S Rendra", "Felix Siauw", "Asma Nadia", "Dewi Lestari" }));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if(jTextField3.getText().equals("")){           //mengambil tempat search untuk nilai yang kosong
            JOptionPane.showMessageDialog(null,"ISI DULU YA KAWAN!!!"); //syntax ini digunakan untuk membuat pesan yang telah dibuat jika tidak mengisi kolom search
        }
        else{
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{                                                //didalam perintah hapus data juga terdapat syntax untuk mengatasi kesalahan dalam memasukkan perintah dalam program
            ...
            JOptionPane.showMessageDialog(null, "ANDA YAKIN INGIN MENGHAPUS KAWAN?");
        }
